...
<div>
    <a target="_blank" href="http://www.facebook.com/<?php print $user_profile['field_facebook'][0]['#markup']; ?>">
        <img src="/sites/all/modules/socialmedia/icons/levelten/glossy/32x32/facebook.png">
        &nbsp; Find me on Facebook
    </a>
</div>
<?php endif; ?>
...
<div>
    <a target="_blank" href="https://plus.google.com/<?php print $user_profile['field_googleplus'][0]['#markup']; ?>">
        <img src="/sites/all/modules/socialmedia/icons/levelten/glossy/32x32/googleplus.png">
        &nbsp; Find me on Google+
    </a>
</div>
<?php endif; ?>
